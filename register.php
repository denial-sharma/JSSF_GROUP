...
<body class="bg-light">
  <div class="container mt-5">
    <div class="card">
      <div class="card-body">
        <h3 class="text-center mb-4"><b>Register Here</b></h3>
        <form id="candi_registration" method="post" >

          <h6>Personal Details</h6>
          <div class="form-group row mt-2">
            <label class="form-label col-sm-2 mt-2"> Patent Id<label style="color:red">*</label></label>
            <div class="col-sm-4 mt-2">
              <input type="text" class="form-control" placeholder="Enter Patent Id" name="spon_id" value="<?php echo $_GET['UId']; ?>"  />
            </div>
