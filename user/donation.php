...
<div class="main-content" style="padding-top: 100px;">
    <section class="section">
        <div class="section-body">
            <h5 class="mb-4 bg-dark p-2 text-white">You have to donate every quarter minimum 10rs and Yearly 40rs and maximum as per your wish.</h5>
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="card ">
                        <div class="card-header">
                            <h4>Donation Barcode</h4>
                        </div>
                        <div class="card-body ">
                            ...
                            <!-- <div class="row mt-3">
                                    ...
                                    <div class="col-md-7">                                        
                                        <input type="number" value="10" class="form-control mb-3" id="amount" name="amount" placeholder="Enter Donation Amount" required>
                                    </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr class="bg-dark text-center">
                                            ...
                                            <th class="text-white"> Donation Amount</th>
                                            <th class="text-white">Donation Date</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $fetchrecordobj->donation() ?>
                                </table>
                            </div>
                        </div>
                    </div>
...
<script>
    function savetoserver(payid) {
        ...
        $.ajax({
            type: "POST",
            url: "ajax_page/uploaddonation.php",
            data: {
                userid: userid,
                amt: amt,
                payment_id: payid
