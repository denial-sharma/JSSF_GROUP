...
foreach ($counts as $level => $count) {
    ...
    if ($level != 0) {
        ...
        // } else if ($root == 'JSSF0001') {
        //     if ($count == 0) {
        //         $countToPrint = ($count <= 3) ? $count : 0;
        //         $magicPool1Script .= "<tr class='text-center'>
        //         <td><label>Room $level</label></td>
        //         <td><label>$countToPrint</label></td>
        //         <td><label>0</label></td>
        //     </tr>";
        //     }
        // } else if ($count <= 3 && $root != 'JSSF0001') {
        //     $countToPrint = ($count <= 3) ? $count : 0;
        //     $magicPool1Script .= "<tr class='text-center'>
        //         <td><label>Room $level</label></td>
        //         <td><label>$countToPrint</label></td>
...
?>
<script>
    const magicPool1TableBody = `<?php echo ($magicPool1Script); ?>`;
    const counts = <?php echo json_encode($level); ?>;
    console.log(counts);
</script>
<?php
