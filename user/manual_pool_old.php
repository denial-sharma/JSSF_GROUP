            ...
            <div class="card-body p-0">
              <div class="table-responsive">
                <table class="table table-striped table-md">
                  ...
                  <?php $fetchrecordobj->getmyrefuserlist(); ?>
                </table>
              </div>
            </div>
          </div>
    ...
    <div class="modal-dialog  modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Sponcer</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form method="post" id="assginid">
          <div class="modal-body">
            <label for="reflerid"> Enter a Refler Code</label>
            <input type="hidden" id="userid" name="userid">
            <input type="text" class="form-control" id="refidid" name="refidid" placeholder="Enter Refferel Id">
          </div>
