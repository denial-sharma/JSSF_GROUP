...
<body>
                    ...
                    <div class="card mx-4">
                        <!-- <div class="card-body p-4">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-9">
                                    <input type="hidden" name="uid" id="uid" class="form-control" value="<?php echo $profiledt['user_uid']; ?>" readonly>
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control mb-3" id="amount" name="amount" placeholder="Enter Amount Here" value="700">
                                </div>
                                <div class="col-sm-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Register Barcode</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-12">
                                    <input type="number" class="form-control mb-3" id="amount" value="700" name="amount" placeholder="Enter Donation Amount" required>
                                </div>
                                <div class="col-md-12">
    ...
    <!-- <script>
        ...
        document.getElementById('jssf_rzp_button').onclick = function(e) {
            var amt = $('#amount').val();
            if (amt < 700) {
                alert("Minimum Amount is Rs. 700/-")
                return;
            }
            rzp1.open();
        }
