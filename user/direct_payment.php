...
<body>
                    ...
                    <div class="card mx-4">
                        <div class="card-body p-4">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control mb-3" id="amount" name="amount" placeholder="Enter Amount Here" value="100">
                                </div>
                                <div class="col-sm-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Direct Register Barcode</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-12">
                                    <input type="number" class="form-control mb-3" id="amount" value="100" name="amount" placeholder="Enter Donation Amount" required>
                                </div>
                                <div class="col-md-12">
        ...
        rzp1.on('payment.failed', function(response) {
            Swal.fire(
                ...
                if (result.isConfirmed) {
                    window.location.href = "direct_payment.php";
                }
            })
    ...
    <!-- <script>
        function savetoserver(payid) {
            ...
            $.ajax({
                type: "POST",
                url: "direct_uploadtransition.php",
                data: {
                    userid: userid,
                    amt: amt,
                    payment_id: payid
